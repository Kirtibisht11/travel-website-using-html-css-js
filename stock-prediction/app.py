...
def home():
    ...
    if request.method == 'POST':
        ...
        if model_choice == "LSTM":
            ...
            return "Invalid model choice. Please choose either LSTM or ARIMA."
        ...
        return render_template('output.html', image_file='static/stock_prediction.png', ticker=ticker)
    
    return render_template('frontend.html', tickers=tickers)
